...
def get_opts():
    ...
    parser.add_argument('--encoding_type', type=str, default='style2',
                        help='style1, style2')
    parser.add_argument('--N_freqs', type=int, default=16,
                        help='16 or Num Inputs / 2')
    parser.add_argument('--logscale', type=bool, default=False,
                        help='Depends of style1: True/False')
    parser.add_argument('--encoding', type=int, default=1,
                        help='Depends of style2: None, p=0,1,1.5, 1000')

    parser.add_argument('--num_embedding', type=int, default=33,
                        help='0, 256, 512, 1024')
